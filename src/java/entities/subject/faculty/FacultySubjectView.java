...
@NamedQueries({
    ...
    @NamedQuery(name = "FacultySubjectView.findByIdFacultyCurrent", query = "SELECT f FROM FacultySubjectView f WHERE f.idFaculty = :idFaculty AND f.acDate = '2015-07-08' ORDER BY f.idProgram, f.idCourse, f.semester, f.subjectCode, f.division, f.batch"),
