...
public class CurrentStudentFacade extends AbstractFacade<CurrentStudent> {
    ...
    public List<CurrentStudent> getCurrentStudentByDiv(Course course, short semester, String div, short batch) {
        List <CurrentStudent> l = new ArrayList();
        
        Query q = em.createNamedQuery("CurrentStudent.findUltimate");
        q.setParameter("idCourse", course);
        ...
        public List<CurrentStudent> getCurrentStudentByDivTheory(Course course, short semester, String div) {
        List <CurrentStudent> l = new ArrayList();
