...
import entities.feedback.OldFbPiDetails;
import controllers.util.JsfUtil;
import controllers.util.PaginationHelper;
import beans.feedback.OldFbPiDetailsFacade;
...
public class OldFbPiDetailsController implements Serializable {
    ...
    @EJB
    private beans.feedback.OldFbPiDetailsFacade ejbFacade;
    ...
    public OldFbPiDetails getOldFbPiDetails(entities.feedback.OldFbPiDetailsPK id) {
    ...
    public static class OldFbPiDetailsControllerConverter implements Converter {
        ...
        entities.feedback.OldFbPiDetailsPK getKey(String value) {
            entities.feedback.OldFbPiDetailsPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entities.feedback.OldFbPiDetailsPK();
        ...
        String getStringKey(entities.feedback.OldFbPiDetailsPK value) {
