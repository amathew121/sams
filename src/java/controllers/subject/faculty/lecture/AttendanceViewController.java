...
import beans.subject.faculty.lecture.AttendanceViewFacade;
...
@Named("attendanceViewController")
@SessionScoped
public class AttendanceViewController implements Serializable {
    ...
    @EJB
    private beans.subject.faculty.lecture.AttendanceViewFacade ejbFacade;
