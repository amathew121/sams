...
import beans.users.UserGroupFacade;
...
public class UserGroupController implements Serializable {
    ...
    @EJB
    private beans.users.UserGroupFacade ejbFacade;
    ...
    public static class UserGroupControllerConverter implements Converter {
        ...
        entities.users.UserGroupPK getKey(String value) {
            entities.users.UserGroupPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entities.users.UserGroupPK();
            key.setUserName(values[0]);
            key.setRoleName(values[1]);
            return key;
        }

        String getStringKey(entities.users.UserGroupPK value) {
