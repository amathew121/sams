...
import beans.users.CoordinatorFacade;
...
public class CoordinatorController implements Serializable {
    ...
    public static class CoordinatorControllerConverter implements Converter {
        ...
        entities.users.CoordinatorPK getKey(String value) {
            entities.users.CoordinatorPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entities.users.CoordinatorPK();
        ...
        String getStringKey(entities.users.CoordinatorPK value) {
