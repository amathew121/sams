...
import beans.LectureTagsFacade;
...
public class LectureTagsController implements Serializable {
    ...
    @EJB
    private beans.LectureTagsFacade ejbFacade;
    ...
    public LectureTags getSelected() {
        if (current == null) {
            ...
            current.setLectureTagsPK(new entities.LectureTagsPK());
            selectedItemIndex = -1;
        }
        return current;
    }
     ...
     * @return
     */
    public LectureTags getLectureTags(entities.LectureTagsPK id) {
    ...
    public static class LectureTagsControllerConverter implements Converter {
        ...
        entities.LectureTagsPK getKey(String value) {
            entities.LectureTagsPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entities.LectureTagsPK();
            key.setIdLecture(Integer.parseInt(values[0]));
            key.setTag(values[1]);
            return key;
        }

        String getStringKey(entities.LectureTagsPK value) {
